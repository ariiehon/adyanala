        ...
        <div>
          ...
          <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg">
            ...
            <ul className="text-sm text-gray-600 mt-2 space-y-1 ml-4">
              ...
              <li>• Khusus <strong>Departemen Sekretaris/Bendahara</strong>: Centang "Daftar Departemen Sekben" pada pilihan yang kamu inginkan</li>
